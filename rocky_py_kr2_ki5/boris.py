...
if __name__ == "__main__":
  ...
  def vector_potential(x, t):
    if x < 0:
      return -1.76470588235294*sin(1.0*t + 1.0*x) + 6.0*cos(1.0*t - 1.0*x) - 4.94117647058824*cos(1.0*t + 1.0*x)
    else:
      return (-1.76470588235294*sin(1.0*t - 2.0*x) + 1.05882352941176*cos(1.0*t - 2.0*x))*exp(-5.0*x)
