...
if __name__ == "__main__":
  ...
  def vector_potential(x, t):
    if x < 0:
      return -3.69230769230769*sin(1.0*t + 1.0*x) + 6.0*cos(1.0*t - 1.0*x) - 0.461538461538462*cos(1.0*t + 1.0*x)
    else:
      return (-3.69230769230769*sin(1.0*t - 0.5*x) + 5.53846153846154*cos(1.0*t - 0.5*x))*exp(-1.0*x)
