...
if __name__ == "__main__":
  ...
  def vector_potential(x, t):
    if x < 0:
      return -2.36065573770492*sin(1.0*t + 1.0*x) + 6.0*cos(1.0*t - 1.0*x) - 4.0327868852459*cos(1.0*t + 1.0*x)
    else:
      return (-2.36065573770492*sin(1.0*t - 1.5*x) + 1.9672131147541*cos(1.0*t - 1.5*x))*exp(-3.0*x)
