...
if __name__ == "__main__":
  ...
  for i in range(no_o_frames):
    ...
    plt.imshow(frame, cmap=plt.cm.PuOr, vmin=-12., vmax=12., extent=[-p2_max, p2_max, -p1_max,0.])
    plt.colorbar()
    plt.imshow(Y, extent=[-p2_max, p2_max, -p1_max,0.], interpolation = 'none')
    index = "%03d" % i
