...
PROGRAM boris_push
 ...
 DO
  ...
  IF ( j > 100) THEN
   j = 1
   call p2p1_dump(particle_array,t)
  END IF
 ...
 SUBROUTINE p2p1_dump(particle_array,t)
  ...
  file_name = 'p2p1-' // t_char // '.dat'


  OPEN(UNIT=9,FILE=file_name,STATUS='replace',FORM='unformatted')
  WRITE(UNIT=9) p2p1
  CLOSE(UNIT=9)
 END SUBROUTINE p2p1_dump
