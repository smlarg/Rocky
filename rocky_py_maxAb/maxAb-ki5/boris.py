...
if __name__ == "__main__":
  ...
  def vector_potential(x, t):
    if x < 0:
      return -0.964660637834179*sin(1.0*t + 1.0*x) + 6.0*cos(1.0*t - 1.0*x) - 4.8233031891709*cos(1.0*t + 1.0*x)
    else:
      return (-0.964660637834179*sin(1.0*t - 5.09901951359278*x) + 1.1766968108291*cos(1.0*t - 5.09901951359278*x))*exp(-5.0*x)
