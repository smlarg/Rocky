...
if __name__ == "__main__":
  ...
  def vector_potential(x, t):
    if x < 0:
      return -1.36754446796632*sin(1.0*t + 1.0*x) + 6.0*cos(1.0*t - 1.0*x) - 4.10263340389897*cos(1.0*t + 1.0*x)
    else:
      return (-1.36754446796632*sin(1.0*t - 3.16227766016838*x) + 1.89736659610103*cos(1.0*t - 3.16227766016838*x))*exp(-3.0*x)
