...
if __name__ == "__main__":
  ...
  def vector_potential(x, t):
    if x < 0:
      return -1.1361965624455*sin(1.0*t + 1.0*x) + 6.0*cos(1.0*t - 1.0*x) - 4.544786249782*cos(1.0*t + 1.0*x)
    else:
      return (-1.1361965624455*sin(1.0*t - 4.12310562561766*x) + 1.455213750218*cos(1.0*t - 4.12310562561766*x))*exp(-4.0*x)
