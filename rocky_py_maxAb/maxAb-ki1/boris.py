...
if __name__ == "__main__":
  ...
  def vector_potential(x, t):
    if x < 0:
      return -1.75735931288071*sin(1.0*t + 1.0*x) + 6.0*cos(1.0*t - 1.0*x) - 1.75735931288071*cos(1.0*t + 1.0*x)
    else:
      return (2.48528137423857*cos(1.0*t - 1.4142135623731*x) + 2.48528137423857*cos(t - 1.4142135623731*x + pi/4))*exp(-1.0*x)
