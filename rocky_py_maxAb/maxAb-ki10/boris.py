...
if __name__ == "__main__":
  ...
  def vector_potential(x, t):
    if x < 0:
      return -0.540297768587401*sin(1.0*t + 1.0*x) + 6.0*cos(1.0*t - 1.0*x) - 5.40297768587401*cos(1.0*t + 1.0*x)
    else:
      return (-0.540297768587401*sin(1.0*t - 10.0498756211209*x) + 0.597022314125993*cos(1.0*t - 10.0498756211209*x))*exp(-10.0*x)
